...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo $admin_url?>about_list/<?php echo $types;?>"><?php echo ucwords($types);?> List</a>
		</li>
	</ul>	
</div>
				...
				<div class="box box-primary" style="padding-top:20px;">
					...
					<div class="col-md-12" style="margin-bottom:10px;">
						<div class="col-md-2 text_box_padding">
							<input type="text" class="form-control" placeholder="TAL UNIQUE ID" id="ma_tal_id" name="ma_tal_id"/> 
						</div>
						<div class="col-md-2 text_box_padding">
...
<script>
	...
	$(document).ready(function() {
		...
		$("#btn_reset").click(function () {
			document.getElementById("ma_tal_id").value = '';  
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"ma_title="+ma_title+"&ma_tal_id="+ma_tal_id+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&types=<?php echo $types;?>",
			url:"<?php echo $admin_url?>ad_data.php?call=live_about_list",
			beforeSend: function(){
				$(".response_gif").show();
			},
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $admin_url ?>about/<?php echo $types;?>/"+btoa(id);
	} 
</script>
<style>
	p{
