...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li>
			...
			<a href="email_management">E-Mail & SMS Templates</a>
		</li>
	</ul>
</div>
					...
					<div style="margin-bottom:50px;overflow-x:auto;text-align:center;margin-top: 15px;" class="col-md-12">
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url ?>email_catagory_master">
								<div class="visual">
						...
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url ?>email_template_list">
								<div class="visual">
									<i class="fa fa-comments"></i>
								</div>
								<div class="details">
						...
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url ?>telephone_interview_question_list">
								<div class="visual">
									<i class="fa fa-comments"></i>
								</div>
								<div class="details">
