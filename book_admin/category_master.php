...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li>
			...
			<a href="product_service_master">Product Category Master</a>
					...
					<div class="col-md-12" style="margin-bottom:50px;overflow-x:auto;text-align:center;margin-top: 15px;">
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 div_pending_zero">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url?>master_list/product/5">
								<div class="visual">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 div_pending_zero">
							<div class="dashboard-stat red-intense">
								<a href="<?php echo $admin_url?>prime_list/product/5">
								<div class="visual">
						...
						<div class="col-lg-3 col-md-3 col-sm-6 col-xs-12 div_pending_zero">
							<div class="dashboard-stat green-haze">
								<a href="<?php echo $admin_url?>sub_list/product/5">
								<div class="visual">
