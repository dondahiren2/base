...
<div class="page-bar">
	<ul class="page-breadcrumb">
		...
		<li>
			<a href="<?php echo $admin_url?>events_list">Events List</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="#">Event</a>
...
<?php
	if(isset($_GET['ids'])){
		...
		$mast = $con->query("select te_id, te_start_date, te_end_date, te_title, te_stime, te_etime, te_Topics_id, te_details, te_Venue, te_img, te_Organised, te_email, te_mno, te_Note, te_status from micro_events where te_id = '$m_id' ");
					...
					<div class="portlet light bordered">
						...
						<div class="portlet-body ">
							...
							<div class="form-group col-md-12">
								...
								<label style="padding-left: 15px; letter-spacing: 2px; font-size: 13px; height: 20px; font-weight:normal;float:right;"></label>
							</div>
							<?php
                    ...
                    ?>
							...
							<div class="form-group col-md-6">
								...
								<div class="col-xs-12">
									...
									<select class="form-control" id="te_status" name="te_status" >
										<option value=""></option>
										<option value="pending" <?php if($r['te_status'] == 'pending'){ echo 'selected'; } ?> >Pending</option>
										<option value="activated" <?php if($r['te_status'] == 'activated'){ echo 'selected'; } ?> >Activated</option>
										<option value="rejected" <?php if($r['te_status'] == 'rejected'){ echo 'selected'; } ?> >Rejected</option>
									</select>
								</div>
								<div class="col-xs-12 footer_border">
									<input type="submit" class="btn btn-primary" id="add_mast" name="add_mast" value="Submit" />
									<a href="<?php echo $admin_url?>events_list" class="btn btn-primary">List</a>	
								</div>
							</div>
...
var requ;
 $(document).ready(function() {
	...
	$("#add_mast").on('click', function(){
		...
		var te_status = document.getElementById("te_status").value;
