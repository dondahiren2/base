						...
						<table width="100%" class="table table-striped table-bordered table-vcenter" style="border:1px solid #fff;" cellspacing='0' cellpadding='5' >
							<thead>
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:150px;text-align:left">Slogan1</th>
									<th style="width:150px;text-align:left">Slogan2</th>
									<th style="width:150px;text-align:left">Slogan3</th>
									<th style="width:150px;text-align:left">Slogan4</th>
									<th style="width:150px;text-align:left">Slogan5</th>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#create_master_category").click(function() { 
			window.location = "<?php echo $admin_url ?>slogan";
		});
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			...
			url:"<?php echo $admin_url?>ad_data.php?call=slogan_list",
			beforeSend: function(){
				$(".response_gif").show();
			},
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $admin_url ?>slogan/"+btoa(id);
	}
</script>
<style>
	p{
