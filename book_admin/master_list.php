				...
				<div class="box box-primary" style="padding-top:20px;">
					...
					<div class="col-md-12" style="margin-bottom:10px;">
						<div class="col-md-3 text_box_padding">
							...
							<input type="hidden" id="m_cc_name" name="m_cc_name" value="<?php echo $title ?>" />
						</div>
						<div class="col-md-3 text_box_padding">
						...
						<table width="100%" class="table table-striped table-bordered table-vcenter" style="border:1px solid #fff;" cellspacing='0' cellpadding='5' >
							<thead>
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:250px;text-align:left">Master Category Name
...
<script>
	...
	$(document).ready(function() {
		...
		$("#create_master_category").click(function() { 
			window.location = "<?php echo $admin_url ?>master_cate/<?php echo $title?>/<?php echo $title_ids ?>/create";
		});	
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"m_name="+m_name+"&m_cc_name="+m_cc_name+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&display=0",
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $admin_url ?>master_cate/<?php echo $title?>/<?php echo $title_ids ?>/"+btoa(id);
	}
