				...
				<div class="col-md-12">
					<div class="box box-primary col-md-12" style="padding: 15px 0px;">
						...
						<div class="row" style="padding-top:0px;margin-bottom:10px;">
							...
							<div class="col-md-2 paddingRight">
								<select class="form-control saerchbtn" id="state" name='state'>
							...
							<div class="col-md-2 paddingRight">
								<select class="form-control saerchbtn" id="city" name='city'>
							...
							<div class="col-md-2 paddingRight">
								<select class="form-control saerchbtn" id="source" name='source'>
							...
							<div class="col-md-3 paddingRight">
								<select class="form-control saerchbtn" id="m_status" name='m_status'>
							...
							<div class="col-md-3 paddingRight">
								<select class="form-control getData saerchbtn" id="designation" name="designation"  placeholder="">
						...
						$cr= $con->query("select ur_id, p_name, m_name, ur_r_type, ur_status from user_role as ur join master_category as m on ur.ur_m_id = m.m_id join prime_category as p on ur.ur_p_id = p.p_id where ur.ur_type_of = 'designation' ");
						 ...
						 ?>
							...
							<div class="col-md-3">
								...
								<input type="submit" class="btn btn-primary" id="add_admin_user" value="Add Contact" />
							</div>
						</div>
						...
						<table width="100%" class="table table-striped table-bordered table-vcenter" style="border:1px solid #fff;" cellspacing='0' cellpadding='5' >
							<thead>
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:100px;text-align:left">Designation
											<span style="width: 10px; float: right;">
										<i class="fa fa-caret-up" id="q_designation" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
										<i class="fa fa-caret-down" id="q_designation" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
...
$(document).ready(function() {
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"f_name="+f_name+"&l_name="+l_name+"&email="+email+"&state="+state+"&city="+city+"&country="+country+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&source="+source+"&m_status="+m_status+"&designation="+designation,
			url:"hd_data.php?call=contact_list",
