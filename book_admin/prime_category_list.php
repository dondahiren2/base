				...
				<div class="box box-primary" style="padding-top:20px;">
					...
					<div class="col-md-12" style="margin-bottom:10px;">
						<div class="col-md-3 text_box_padding">
							<input type="text" class="form-control saerchbtn search_topic_name" placeholder="Topic Name" id="p_cc_name" name="p_cc_name"/>
								...
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:150px;text-align:left">Topic Name
										<span style="width: 10px; float: right;">
											<i class="fa fa-caret-up" id="p_cc_name" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
											<i class="fa fa-caret-down" id="p_cc_name" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#create_master_category").click(function() { 
			window.location = "<?php echo $admin_url ?>prime_category";
		});
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"p_name="+p_name+"&p_m_name="+p_m_name+"&p_cc_name="+p_cc_name+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&display=1",
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $admin_url ?>prime_category/"+btoa(id);
	}
