				...
				<div class="box box-primary" style="padding-top:20px;">
					<div class="col-md-12" style="padding-top:0px;margin-bottom:10px;">
						...
						<div style="float:right">
							<input type="submit" class="btn btn-success"  id="create_master_category" value="Create Form Page" name="create_prime_category" />
						</div>
					</div>
					<div class="col-md-12" style="margin-bottom:10px;">
						<div class="col-md-2 text_box_padding">
							...
							<input type="hidden" id="fp_m_id" name="fp_m_id" value="" />
							<input type="hidden" id="fp_p_id" name="fp_p_id" value="" />
						</div>
						<div class="col-md-2 text_box_padding">
							<input type="text" class="form-control saerchbtn search_prime_name" placeholder="Prime Category Name" id="s_p_name" name="s_p_name"/>
						</div>
						<div class="col-md-2 text_box_padding">
							<input type="text" class="form-control saerchbtn" placeholder="Page Name" id="fp_page_name" name="fp_page_name"/>
						</div>
						<div class="col-md-2 text_box_padding">
							<input type="text" class="form-control saerchbtn" placeholder="Page Code" id="fp_page_code" name="fp_page_code"/>
						</div>
						<div class="col-md-2 text_box_padding">
								...
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:150px;text-align:left">Master Category Name
										<span style="width: 10px; float: right;">
											<i class="fa fa-caret-up" id="fp_m_id" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
											<i class="fa fa-caret-down" id="fp_m_id" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
									<th style="width:150px;text-align:left">Prime Category Name
										<span style="width: 10px; float: right;">
											<i class="fa fa-caret-up" id="fp_p_id" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
											<i class="fa fa-caret-down" id="fp_p_id" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
									<th style="width:150px;text-align:left">Page Name
										<span style="width: 10px; float: right;">
											<i class="fa fa-caret-up" id="fp_page_name" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
											<i class="fa fa-caret-down" id="fp_page_name" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
									<th style="width:150px;text-align:left">Page Code
										<span style="width: 10px; float: right;">
											<i class="fa fa-caret-up" id="fp_page_code" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
											<i class="fa fa-caret-down" id="fp_page_code" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
									<th style="width:150px;text-align:left">Table Name</th>		
...
<script>
	...
	$(document).ready(function() {
		...
		$("#btn_reset").click(function () {
			...
			document.getElementById("fp_m_id").value = '';
			document.getElementById("fp_p_id").value = '';
		...
		$("#create_master_category").click(function() { 
			window.location = "<?php echo $admin_url ?>form_pages";
		});
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"fp_cc_id="+fp_cc_id+"&fp_m_id="+fp_m_id+"&fp_p_id="+fp_p_id+"&fp_page_name="+fp_page_name+"&fp_page_code="+fp_page_code+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort,
			url:"<?php echo $admin_url?>ad_data.php?call=form_page_list",
			beforeSend: function(){
				$(".response_gif").show();
			},
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $admin_url ?>form_pages/"+btoa(id);
	}
	...
	function deletedbtn(id){
		...
		requ = $.ajax({
			type:"POST",
			data:"id="+id,
			url:"<?php echo $admin_url?>ad_data.php?call=form_page_delete",
			beforeSend: function(){
				$(".response_gif").show();
			},
