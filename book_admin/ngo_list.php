...
?>
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="<?php echo $admin_url?>ngo_list">NGO List</a>
			</li>
		</ul>		
	</div>
							...
							<thead>
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:100px;text-align:left">NGO Name
										...
										<i class="fa fa-caret-up" id="bp_crop_name" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
										<i class="fa fa-caret-down" id="bp_crop_name" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>			
									<th style="width:100px;text-align:left">Mobile No
										<span style="width: 10px; float: right;">
										<i class="fa fa-caret-up" id="bp_crop_mobile_no" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
										<i class="fa fa-caret-down" id="bp_crop_mobile_no" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
									<th style="width:100px;text-align:left">Email
										<span style="width: 10px; float: right;">
										<i class="fa fa-caret-up" id="bp_crop_email" data-id="asc" aria-hidden="true" style="float: right; position: absolute;cursor: pointer;"></i>
										<i class="fa fa-caret-down" id="bp_crop_email" data-id="desc"  aria-hidden="true" style="float: right; position: absolute; margin-top: 10px;cursor: pointer;"></i>
										</span>
									</th>
...
$(document).ready(function() {
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			...
			url:"<?php echo $admin_url?>ad_data.php?call=ngo_list",
...
function editbtn(id){ 
	window.location = "<?php echo $admin_url?>more_ngo.php?id="+id;
}
...
function emailid(){
	$.ajax({
		type:"post",
		url:"<?php echo $admin_url?>ad_data.php?call=email_ngo",
		success:function(msg){
			$("#emailid").html(msg);
		}
	});
