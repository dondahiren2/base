						...
						<table width="100%" class="table table-striped table-bordered table-vcenter" style="border:1px solid #fff;" cellspacing='0' cellpadding='5' >
							<thead>
								<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
									...
									<th style="width:150px;text-align:left">Facebook</th>
									<th style="width:150px;text-align:left">Google Plus</th>
									<th style="width:150px;text-align:left">Twitter</th>
									<th style="width:150px;text-align:left">Instagram</th>
...
<script>
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			...
			url:"<?php echo $admin_url?>ad_data.php?call=social_media_list",
			beforeSend: function(){
				$(".response_gif").show();
			},
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $admin_url ?>social_media/"+btoa(id);
	}
</script>
<style>
	p{
