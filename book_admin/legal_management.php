					...
					<div style="margin-bottom:50px;overflow-x:auto;text-align:center;margin-top: 15px;" class="col-md-12">
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url ?>legal_catagory_master">
								<div class="visual">
						...
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url ?>legal_list">
								<div class="visual">
									<i class="fa fa-comments"></i>
								</div>
								<div class="details">
									...
									<div class="desc">
									 Create Legal & Certificate Section
									</div>
								</div>
								</a>
							</div>
						...
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $admin_url ?>legal_document_create_list">
								<div class="visual">
									<i class="fa fa-comments"></i>
								</div>
								<div class="details">
