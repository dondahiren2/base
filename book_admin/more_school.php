...
?>
	...
	<div class="page-bar">
		<ul class="page-breadcrumb">
			...
			<li>
				<a href="<?php echo $admin_url?>school_list">School List</a>
				<i class="fa fa-angle-right"></i>
			</li>
			<li>
	...
	$('.upload-result').on('click', function (ev) {
		$uploadCrop.croppie('result', {
			...
			$.ajax({
				...
				type: "POST",
				data: {"image":resp, "type":"SCL", "parts":"logo", "unique_id": unique_id, "tal_id": tal_id, "names": bp_crop_name },
