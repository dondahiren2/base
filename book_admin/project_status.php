...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li>
			...
			<a href="<?php echo $admin_url?>project_master">Project Master</a>
			<i class="fa fa-angle-right"></i>
		</li>
		<li>
			<a href="<?php echo $admin_url?>project_list_master">Project List</a>
			<i class="fa fa-angle-right"></i>
		</li>
		
		<li>
			<a href="#"><?php echo ucwords($status);?> Project</a>
		</li>
	</ul>
</div>
