...
?>
				<div class="col-md-6 col-md-offset-3">
					<div class="portlet light bordered">
						<div class="row">
							<h3 class="col-xs-12 form-title">Edit Usefull Link</h3>
						</div>
						<div class="portlet-body ">
							<div class="row">
								<div class="col-xs-12">
									<p class="text_margin_0">Usefull Link Title :</p>
									<input type="text" class="form-control getData" placeholder="Usefull Link Title" id="mn_title" name="mn_title" value="<?php echo $r['mn_title'];?>" />
								...
								<div class="col-xs-12">
									...
									<form method="post" name="banner" id="banner" enctype="multipart/form-data" action="<?php echo $site_url?>upload_micro_img.php" style="padding: 0px; margin: 0px;">
										...
										<input type="hidden" id="parts" name="parts" value="usefull_link" /> 
									</form>
								...
								<div class="col-xs-12 footer_border">
									...
									<a href="<?php echo $user_url?>usefull_link_list" class="btn btn-primary">List</a>	
								</div>
							</div>
						</div>
					</div>
	...
	<?php 
				...
				<div class="col-md-6 col-md-offset-3">
					<div class="portlet light bordered">
						<div class="row">
							<h3 class="col-xs-12 form-title">Create Usefull Link</h3>
						</div>
						<div class="portlet-body ">
							<div class="row">
								<div class="col-xs-12">
									<p class="text_margin_0">Usefull Link Title :</p>
									<input type="text" class="form-control getData" placeholder="Usefull Link Title" id="mn_title" name="mn_title" />
