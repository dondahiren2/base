...
loadData(page,fields,ord_sort);
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"studnm="+studnm+"&scl_nm="+scl_nm+"&email="+email+"&ngo_id="+ngo_id+"&vl_nm="+vl_nm+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort,
			url:"user_data.php?call=ngo_sudent_list",
...
function gotoexcel(){ 
		...
		window.open("../demo_excel_new.php?studnm="+studnm+"&scl_nm="+scl_nm+"&email="+email+"&ngo_id="+ngo_id+"&vl_nm="+vl_nm+"&type=ngo");
