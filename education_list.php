				...
				<div class="box box-primary" style="padding-top:20px;">
					<div class="col-md-12" style="padding-top:0px;margin-bottom:10px;">
						...
						<div style="float:right">
							<input type="submit" class="btn btn-success"  id="create_master_category" value="Create Education" name="create_prime_category" />
						</div>
					</div>
					<div class="col-md-12" style="margin-bottom:10px;">
						<div class="col-md-2 text_box_padding">
							<input type="text" class="form-control" placeholder="Education Title" id="mn_title" name="mn_title"/> 
						</div>
						<div class="col-md-2 text_box_padding">
...
<script>
	...
	$(document).ready(function() {
		...
		$("#create_master_category").click(function() { 
			window.location = "<?php echo $user_url ?>education";
		});
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $user_url ?>education/"+btoa(id);
	}
