<div class="page-sidebar-wrapper">
		...
		<header class="sidebar-header" style="border-top:1px solid #b4bcc8;margin-top:20px;border-bottom:1px solid #b4bcc8;margin-bottom:20px;">

          <!-- Sidebar Widget - Author -->
          <div class="sidebar-widget author-widget">
            <a class="author-img" href="#">
              <img src="../img/donors/8.jpg" class="img-responsive">
            </a>
            <a href="#" class="sidebar-menu-toggle sidebar-btn" style="text-decoration:none;">User Menu</a>

          </div>

          <!-- Sidebar Widget - Menu (slidedown) -->
          <div class="sidebar-widget menu-widget" style="display: none;">
            ...
            <div class="input-group">
              ...
              <input type="text" id="sidebar-search" class="form-control" placeholder="Search...">
				...
				<li class="start">
					<a href="">
					<i class="icon-list"></i>
					<span class="title">Communication Channel</span>
					</a>
				</li>
				<li class="start">
					<a href="stud_ecademic_list.php">
					<i class="icon-list"></i>
					<span class="title">Education Profile</span>
					</a>
				</li>
				<li class="start">
					<a href="">
					<i class="icon-list"></i>
					<span class="title">Special Achievement</span>
					</a>
				</li>
				<li class="start">
					<a href="">
					<i class="icon-list"></i>
					<span class="title">Past project Beneficiary</span>
					</a>
				</li>
				<li class="start cur_proj">
					<a href="index_old.php#projstatus">
					<i class="icon-list"></i>
					<span class="title">Current Project Status</span>
					</a>
				</li>
				<li class="start">
					<a href="">
					<i class="icon-list"></i>
					<span class="title">Specific Request by Student</span>
					</a>
				</li>
			</ul>
		</div>
