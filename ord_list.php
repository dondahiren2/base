...
loadData(page,fields,ord_sort);
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"txid="+txid+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&schl_id="+schl_id,
			//data:"scl_nm="+scl_nm+"&ngo_id="+ngo_id+"&vl_nm="+vl_nm+"&sel_class="+sel_class+"&stud_medium="+stud_medium+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort,
			url:"user_data.php?call=ord_listschl",
