				...
				<div class="box box-primary" style="padding-top:20px;">
					...
					<div class="col-md-12" style="margin-bottom:10px;">
						<div class="col-md-2 text_box_padding">
							<input type="text" class="form-control" placeholder="Testimonial Name" id="mn_title" name="mn_title"/> 
						</div>
						<div class="col-md-2 text_box_padding">
...
<script>
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			...
			url:"<?php echo $admin_url?>ad_data.php?call=testimonial_list",
			beforeSend: function(){
				$(".response_gif").show();
			},
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $user_url ?>testimonial/"+btoa(id);
	}
