				...
				<div class="box box-primary" style="padding-top:20px;">
					<div class="col-md-12" style="padding-top:0px;margin-bottom:10px;">
						...
						<div style="float:right">
							<input type="submit" class="btn btn-success"  id="create_master_category" value="Create Events" name="create_prime_category" />
						</div>
					</div>
...
<script>
	...
	$(document).ready(function() {
		...
		$("#create_master_category").click(function() { 
			window.location = "<?php echo $user_url ?>events";
		});
	...
	function loadData(page,fields,ord_sort){
		...
		requ = $.ajax({
			type:"POST",
			data:"mn_title="+mn_title+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&mn_type=education",
			url:"<?php echo $admin_url?>ad_data.php?call=events_list",
			beforeSend: function(){
				$(".response_gif").show();
			},
	...
	function editbtn(id){ 
		$(".response_gif").show();
		window.location = "<?php echo $user_url ?>events/"+btoa(id);
	}
