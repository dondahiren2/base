										...
										<table width="100%" class="table table-striped table-bordered table-vcenter" style="border:1px solid #fff;" cellspacing='0' cellpadding='5' >
											<thead>
												<tr style="background-color: rgb(46, 158, 177); color: rgb(255, 255, 255);">
													...
													<th style="width:100px;text-align:left">Quatation <br/>Details</th>
													<th style="width:100px;text-align:left">Qty</th>
													<th style="width:100px;text-align:left">Per<br/> Price</th>
													<th style="width:100px;text-align:left">Shipping <br/>Charge</th>
													<th style="width:100px;text-align:left">Tax</th>
													<th style="width:100px;text-align:left">Total<br/> Price</th>
...
loadData(page,fields,ord_sort);    
	function loadData(page,fields,ord_sort){  
		...
		requ = $.ajax({
			type:"POST",
			data:"page="+page+"&fields="+fields+"&ord_sort="+ord_sort+"&v_id="+v_id,
			url:"user_data.php?call=product_list",
...
function totalamount(qty,p_id,qtaut_id){
	//alert(qty);
	...
	$.ajax({
		type:"post",
		data:"price_id="+price_id+"&qty="+qty+"&charge="+charge+"&v_id="+v_id+"&p_id="+p_id+"&qt_det="+qt_det+"&tax="+tax+"&qtaut_id="+qtaut_id, 
...
function gettotal(){
	...
	total = (parseFloat(qty) * parseFloat(price_id)) + ( parseFloat(qty) * parseFloat(charge)) + (parseFloat(qty) * parseFloat(tax));
	$("#total").html(total);
}
</script>
<!-- END JAVASCRIPTS -->
