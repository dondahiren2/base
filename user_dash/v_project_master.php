...
<div class="page-bar">
	<ul class="page-breadcrumb">
		<li>
			...
			<a href="v_project_master">Project Master</a>
					...
					<div class="col-md-12" style="margin-bottom:50px;overflow-x:auto;text-align:center;margin-top: 15px;">
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $site_url?>user_dash/v_current">
								<div class="visual">
							...
							<div class="dashboard-stat blue-madison">
								<a href="<?php echo $site_url?>user_dash/upcoming">
								<div class="visual">
									<i class="fa fa-comments"></i>
								</div>
								<div class="details">
						...
						<div class="col-lg-3 div_pending_zero col-md-3 col-sm-6 col-xs-12">
							<div class="dashboard-stat red-intense">
								<a href="<?php echo $site_url?>user_dash/past">
								<div class="visual">
...
<script type="application/javascript" >
	$(document).ready(function() {
		$(".nav_project_management").addClass('active_head');		
	}); 	
</script> 
</body>
</html>