...
loadData(page,fields,ord_sort);
	function loadData(page,fields,ord_sort){
		...
		var ngonm = document.getElementById("ng_nm").value;
		var email = document.getElementById("email").value;
		var vol_id = document.getElementById("vl_id").value;
		...
		requ = $.ajax({
			type:"POST",
			data:"sclnm="+sclnm+"&ngonm="+ngonm+"&email="+email+"&vol_id="+vol_id+"&page="+page+"&fields="+fields+"&ord_sort="+ord_sort,
			url:"user_data.php?call=school_list",
...
function emailid(){
	...
	$.ajax({
		type:"post",
		data:"vl_id="+vl_id, 
		url:"user_data.php?call=email_stud_scl",
		success:function(msg){
			//alert(msg);
			$("#emailid").html(msg);
		}
...
function gotoexcel(){ 
	//alert("1");
	var sclnm = document.getElementById("sclnm").value;
	var ngo_id = document.getElementById("ng_nm").value;
	var email = document.getElementById("email").value;
	var vl_nm = document.getElementById("vl_id").value;
	//alert(ngo_id);
	window.open("../demo_excel_school.php?sclnm="+sclnm+"&email="+email+"&vl_nm="+vl_nm+"&ngo_id="+ngo_id+"&type=volunteer");
