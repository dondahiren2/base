					...
					<aside class="right-side">
						...
						<section class="content">
							<div class="row"> 
								<div class="col-md-12 admin-grid" id="grid-1" style="border: 1px solid rgba(0,0,0,.15);border-radius: 4px;box-shadow: 0 1px 3px rgba(0,0,0,.05), 0 1px 2px rgba(0,0,0,.1);">
									<div class="panel panel-widget calendar-widget calendar-alt" id="p02">
										...
										<div class="panel-body" style="overflow-x:auto;color:black;font-size:14px;margin-top:20px;margin-bottom:20px;">
											<table id="mytable" cellpadding="10" style="width:100%">
												<thead>
												...
												<tbody id="table1">
													<tr id="mainwid" style="width:110%">
														<td style="width:20%" style="padding-top:10px;">Gajera High School</td>
														<td style="width:40%" style="padding-top:10px;">Katargam-Amreli Road, Katargam, Surat, Gujarat 395004.</td>
														<td style="width:10%" style="padding-top:10px;">CBSC</td>
														<td style="width:10%" style="padding-top:10px;">7th</td>
														<td id="wid" style="width:10%" style="padding-top:10px;">Gujarati</td>
														<td style="width:20%" style="padding-top:10px;">Maheshbhai Shah</td>
													</tr>
												</tbody>
											</table>
										</div>
								...
								<div class="col-md-12 admin-grid" id="grid-1" style="margin-top:30px;border: 1px solid rgba(0,0,0,.15);border-radius: 4px;box-shadow: 0 1px 3px rgba(0,0,0,.05), 0 1px 2px rgba(0,0,0,.1);">
									<div class="panel panel-widget calendar-widget calendar-alt" id="p02">
										<div class="panel-heading ui-sortable-handle">
								...
								<div class="col-md-12 col-sm-12 col-xs-12 admin-grid" id="projstatus" style="margin-top:30px;border: 1px solid rgba(0,0,0,.15);border-radius: 4px;box-shadow: 0 1px 3px rgba(0,0,0,.05), 0 1px 2px rgba(0,0,0,.1);">
									<div class="panel panel-widget calendar-widget calendar-alt" id="p02">
										<div class="col-xs-12 panel-heading ui-sortable-handle">
											<div class="panel-title"> Current Project Application Status</div>
										</div>
										<div class="col-xs-12 panel-body" style="margin-left:20px;font-size:14px;">
										...
										<div class="col-xs-12" style="border-top: 1px solid #dadada;padding:10px;">
										</div>
									</div>
								</div>	<!--/.col (left) -->
								<div class="col-md-12 col-sm-12 col-xs-12 admin-grid" id="grid-1" style="margin-top:30px;border: 1px solid rgba(0,0,0,.15);box-shadow: 0 1px 3px rgba(0,0,0,.05), 0 1px 2px rgba(0,0,0,.1);">
									<div class="panel panel-widget calendar-widget calendar-alt" id="p02">
										<div class="panel-heading ui-sortable-handle">
											<span class="panel-title"> Project Status</span>
										</div>
										<div class="panel-body" style="color:black;font-size:14px;margin-top:20px;margin-bottom:20px;overflow-x:auto;">
											<table id="mytable" cellpadding="10" width="100%">
												<thead>
													<tr style="border-bottom: 1px solid rgba(0,0,0,.15);box-shadow: 0px 5px 4px -3px rgba(0, 0, 0, 0.13);, 0 1px 2px rgba(0,0,0,.1);">
														<th></th>
														<th>Syllabus Requirement List</th>
														<th>Delivery Status</th>
													</tr>
												</thead>
												<tbody id="table1">
													<tr width="70%">
														<td width="30%" style="padding-top:10px;" rowspan="3">Student Application List 128 Students</td>
													...
													<tr width="40%">
														<td width="30%" style="padding-top:10px;">28 Sets Standard 10 –M</td>
														<td width="10%" style="padding-top:10px;">In Truck</td>
													</tr>
												</tbody>
											</table>
										</div>
